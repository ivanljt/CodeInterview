...
//        return minIndex == Integer.MAX_VALUE ? '#' : (char)minIndex;
    ...
    public static void main(String[] args) {
        System.out.println(new SolutionRecord().FirstAppearingOnce("")); // '\0'
        System.out.println(new SolutionRecord().FirstAppearingOnce("g")); // 'g'
        System.out.println(new SolutionRecord().FirstAppearingOnce("go")); // 'g'
        System.out.println(new SolutionRecord().FirstAppearingOnce("goo")); // 'g'
        System.out.println(new SolutionRecord().FirstAppearingOnce("goog")); // '\0'
        System.out.println(new SolutionRecord().FirstAppearingOnce("googl")); // l
        System.out.println(new SolutionRecord().FirstAppearingOnce("googlea0")); // l
    }
}
